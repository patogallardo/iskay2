...
static inline int get_weight_method_by_name(const char *name, weight_method_t *method){
    ...
    if(strcmp(name, "c2_ferreira") == 0 || strcmp(name, "c2") == 0){
        *method = C2_FERREIRA;
        return EXIT_SUCCESS;
    }
    if(strcmp(name, "c_ferreira") == 0 || strcmp(name, "c") == 0){
        *method = C_FERREIRA;
        return EXIT_SUCCESS;
    }
    if(strcmp(name, "c_dT_ferreira") == 0 || strcmp(name, "cdT") == 0){
        *method = C_dT_FERREIRA;
        return EXIT_SUCCESS;
    }
    if(strcmp(name, "dT_ferreira") == 0 || strcmp(name, "dT") == 0){
        *method = dT_FERREIRA;
        return EXIT_SUCCESS;
    }
